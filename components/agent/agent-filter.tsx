...
import {initialState, setAgentFilters} from "@/store/agentSlice";
...
export default function AgentFilter() {
    ...
    const clearDisabled = JSON.stringify(filters) === JSON.stringify(initialState.filters);
    ...
    return (
        <Card className="w-full px-5 py-4 md:px-8 md:py-6 mb-6 mx-auto rounded-2xl">
            <div className="flex items-center justify-between mb-2 md:mb-4">
                ...
                <Button disabled={clearDisabled} variant="outline" size="sm" onClick={clearAll}>
                    Clear All Filters
                </Button>
            </div>
